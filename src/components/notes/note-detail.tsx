...
export function NoteDetail({
  ...
  return (
    <article className="notes-panel hud-frame notes-cosmos vn-stars relative overflow-hidden rounded-[34px] px-6 py-8 text-ink sm:px-10 sm:py-10">
      <div className="notes-grid absolute inset-0 opacity-24" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(255,255,255,0.2),transparent_24%),linear-gradient(180deg,transparent,rgba(236,241,255,0.24)_76%,rgba(220,228,246,0.42)_100%)]" />
      <div className="relative">
        ...
        <div className="mt-5 grid gap-5 lg:grid-cols-[1fr_18rem]">
          <div>
            <p className="text-xs font-semibold tracking-[0.18em] text-ink-soft uppercase">
              episode view / {categoryInfo.signal}
            </p>
          ...
          <div className={`vn-ribbon rounded-[28px] bg-gradient-to-br ${categoryInfo.accent} px-5 py-5 text-[#10172a]`}>
        ...
        <div className="note-body relative mt-8 rounded-[28px] border border-white/48 bg-white/72 px-5 py-6 shadow-[0_18px_44px_rgba(95,113,152,0.14)] sm:px-7">
